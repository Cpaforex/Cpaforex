...
window.networkShowUserPopup = async function(address, user) {
    ...
    popupEl.style = `
      position: fixed; z-index: 9999; top: 64px; left: 0; right: 0;
    ...
    popupEl.innerHTML = `
      <div class="user-info-card">
        <button class="close-btn" id="close-network-user-popup">×</button>
    ...
    const closeBtn = document.getElementById('close-network-user-popup');
    if (closeBtn) closeBtn.onclick = () => popupEl.remove();
